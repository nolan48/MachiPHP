...
$sqlAll = "SELECT * FROM user WHERE user_status=0";
...
if (isset($_GET["search"])) {
    ...
    if (isset($_GET['scope']) && $_GET['scope'] == 'id') {
        $sql = "SELECT * FROM user WHERE user_id = '$search' AND user_status=0 $orderString";
    } else {
        ...
        $sql = "SELECT * FROM user WHERE $searchWhatever AND user_status=0  $orderString";
    }
} elseif (isset($_GET["p"])) {
    $p = $_GET["p"];
    $startIndex = ($p - 1) * $perPage;
    $sql = "SELECT * FROM user WHERE user_status=0 $orderString LIMIT $startIndex, $perPage";
} else {
    $p = 1;
    $sql = "SELECT * FROM user WHERE user_status=0 $orderString LIMIT $perPage";
}
                ...
                <div class="container-fluid px-4">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light mc-bg-light-gray">
                        <div class="container-fluid d-flex">
                            <!-- 按鈕 -->
                            <a class="btn btn-outline-success me-2 mc-semi-blue" href="user-list-banned-lily.php"><i class="fa-solid fa-rotate-right"></i></a>
                            ...
                            <!-- 搜尋列和搜尋按鈕 -->
                            <form class="d-flex flex-grow-1" action="user-list-banned-lily.php" method="get">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $user["user_updatetime"] ?></td>
                                            <td><?= $user["user_notes"] ?></td>
                                            <td><a class="btn btn-primary mc-text-semi-primary" href="user-details-banned-lily.php?id=<?= $user["user_id"] ?>" role="button">詳細</a></td>
