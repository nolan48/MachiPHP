        ...
        <div class="container-fluid px-4">
          ...
          <div class="card mb-4">
            <div class="card-header">
              ...
              <button class="btn btn-primary" onclick="location.href='coupon-list.php'"><i class="fa-solid fa-ticket"></i>優惠卷列表</button>
            </div>
            <form action="coupon-do-add.php" method="post">
              <div class="card-body">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                      <td class="fs-4 text">優惠券名稱 </td>
                      <td> <input type="text" name="coupon_name"></td>

                    </tr>
                    <tr>
                      <td class="fs-4 text">優惠券類型 </td>
                      <td> <select id="" name="coupon_type">
                    ...
                    <tr>
                      <td class="fs-4 text">折扣數 </td>
                      <td><input type="text" name="coupon_discount"></td>

                    </tr>
                    <tr>
                      <td class="fs-4 text">最低金額 </td>
                      <td><input type="text" name="coupon_purchase"></td>

                    </tr>
                    <tr>
                      <td class="fs-4 text">起始日期 </td>
                      <td><input type="date" name="coupon_starttime"></td>

                    </tr>
                    <tr>
                      <td class="fs-4 text">截止日期 </td>
                      <td><input type="date" name="coupon_limittime"></td>

                    </tr>

                    <tr>
                      <td class="fs-4 text">優惠券數量 </td>
                      <td><input type="text" name="coupon_count"></td>

                    </tr>
                    <tr>
                      <td class="fs-4 text">優惠券描述 </td>
                      <td><textarea name="coupon_description" class="form-control my-2" required></textarea></textarea>
                      </td>
              ...
              <div class="text-end"> <input type="submit" class="btn btn-success" value="確定">
