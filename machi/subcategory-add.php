            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active">新增子類別</li>
                    </ol>
                                ...
                                <div class="col-md-6">
                                    <div class="card mt-5 shadow">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="subcategory-do-add.php" method="post">

                                                <ul class="list-group list-group-flush d-flex justify-content-center ">
                                                    <li class="list-group-item">
                                                        <div class="container">
                                                            <div class="d-flex row">
                                                                <div class="col-2 d-flex justify-content-center align-items-center">商品類別</div>
                                                                <select class="form-select col" name="category_id">
                                                                    <?php
                                                                    // 在此處列出商品類別的選項
                                                                    foreach ($rows as $row) {
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="row my-2 ">
                                                            <div class="col-2 d-flex justify-content-center align-items-center">子類別</div>
                                                            <div class="col"><input type="text" name="subcategory_name" value="" class="form-control my-2"></div>
                                                        </div>
                                                    </li>
                                                </ul>
                                                ...
                                                <button type="button" class="btn btn-primary add-btn" onclick="window.history.back();">回上一頁</button>
                                                    ...
                                                    <button type="submit" class="btn btn-primary add-btn">新增</button>
                                                </div>
