                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-8">
                                    <div class="card shadow">
                                        ...
                                        <div class="card-body">
                                            <!-- 這裡放使用者的資料 -->
                                            <form action="category-do-add.php" method="post">
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item">
                                                        <div class="row my-2">
                                                            <div class="col"><input type="text" placeholder="請輸入商品類別名稱" name="category_name" value="" class="form-control my-2"></div>
                                                        </div>
                                                    </li>
                                                    <li class="list-group-item">
                                                        <div class="row my-2">
                                                            <div class="col"><input placeholder="請輸入子類別名稱" type="text" name="subcategory_name" value="" class="form-control my-2"></div>
                                                        </div>
                                                    </li>
                                                </ul>
                                                <div class="mt-3 text-center">
                                                    <button type="button" class="btn btn-primary add-btn" onclick="window.history.back();">回上一頁</button>
                                                    <button type="submit" class="btn btn-primary add-btn">送出</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
