                ...
                <div class="container-fluid px-4 my-4">
                    ...
                    <div style="height: 100vh">
                        ...
                        <div class="py-2 d-flex justify-content-between">
                            <a role="button" href="category-add.php" type="button" class="btn btn-primary add-btn">
                                新增商品類別
                            </a>
                        </div>
                        <div class="container-fluid">
                            <div class="row g-5">
                                ...
                                function get_subcategory($category_id)
                                {
                                    ...
                                    // 準備 SQL 查詢
                                    $sql = "SELECT * FROM subcategory WHERE category_id_fk = $category_id AND subcategory_status = 1";
                                ...
                                foreach ($rows as $row) : ?>
                                    <div class="col-4 btn-group">
                                        <button class=" btn btn-light my-3 mr-3 d-flex btn-outline-dark text-right justify-content-between btn-lg rounded" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                            <?= $row["category_name"] ?><i class="fas fa-angle-down"></i>
                                        </button>
                                        <form action="category-do-delete.php" method="post">
                                            <ul class="dropdown-menu px-4 dropdown-menu-end">
                                                <?php
                                                // 根據主分類 ID 獲取子分類
                                                $subcategories = get_subcategory($row["category_id"]);
                                                foreach ($subcategories as $subcategory) : ?>
                                                    <li class="d-flex justify-content-between align-items-center">
                                                        <a class=" dropdown-item" href="#"><?= $subcategory["subcategory_name"] ?></a>
                                                        <input type="hidden" name="subcategory_ids" value="<?= implode(',', array_column($subcategories, 'subcategory_id')) ?>">
                                                        <a href="subcategory-do-delete.php?category_id=<?= $row['category_id'] ?>&subcategory_id=<?= $subcategory['subcategory_id'] ?>" class="btn btn-danger" role="button"><i class="fa-solid fa-trash"></i></a>
                                                ...
                                                <li class="d-flex justify-content-end">
                                                    <a name="" id="" class="btn btn-success" href="subcategory-add.php" role="button">新增</a>
                                                    <a name="" id="" class="btn btn-warning" href="category-edit.php?category_id=<?= $row['category_id'] ?>&subcategory_id=<?= $subcategory['subcategory_id'] ?>" role="button">編輯</a>

                                                    <button type="submit" name="delete_category" value="<?= $row['category_id'] ?>" data-toggle="modal" data-target="#confirmDeleteModal" class="btn btn-danger " role="button">刪除</button>
                                                </li>
                                            </ul>
                                        </form>
                                    </div>
